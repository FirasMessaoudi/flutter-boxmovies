...
import 'package:moviebox/src/core/streams/company_stream.dart';
...
class CompanyResult extends StatelessWidget {
  final String query;
  final int results;
  const CompanyResult({
    Key? key,
...
class CompanyResultWidget extends StatefulWidget {
  final String query;
  final int results;

  const CompanyResultWidget({
    Key? key,
    required this.query,
    required this.results,
  }) : super(key: key);
  @override
  _CompanyResultWidgetState createState() => _CompanyResultWidgetState();
}

class _CompanyResultWidgetState extends State<CompanyResultWidget> {
  final CompanyStream repo = CompanyStream();
