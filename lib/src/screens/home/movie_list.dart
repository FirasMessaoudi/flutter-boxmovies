...
class _MovieListViewState extends State<MovieListView> {
  final MoviesRepo moviesProvider = new MoviesRepo();

  @override
  Widget build(BuildContext context) {
    return FutureBuilder<MovieModelList>(
      future: moviesProvider.getMovieByType(widget.program, widget.type),
      builder: (context, AsyncSnapshot<MovieModelList> snapshot) {
        if (snapshot.hasData) {
  ...
  Widget buildContent(AsyncSnapshot<MovieModelList> snapshot, BuildContext context) {
    return Container(
