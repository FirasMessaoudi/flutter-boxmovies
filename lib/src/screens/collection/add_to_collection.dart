                                ...
                                actions: [
                                  ...
                                  TextButton(
                                      onPressed: () async {
                                        ...
                                        BlocProvider.of<CollectionCubit>(context).addToNewCollection(
                                            devid,con.text,movieid,title,image,rate,date,backdrop,isMovie
                                        );
                                        Navigator.pop(context,true);
                                        Navigator.pop(context,true);
                                        Navigator.of(context).pop();
                                        Fluttertoast.showToast(
                                          msg: 'my_list.added_to_collection'.tr() + con.text,
                            ...
                            children: [
                              ...snp.data!.docs
                                ...
                                child: ListTile(
                                  onTap: () async{
                                    //existing collection
                                    await BlocProvider.of<CollectionCubit>(context).addToExistingCollection(
                                        devid,coll['name'],movieid,title,image,backdrop,rate,date,isMovie
                                    );
                                    Fluttertoast.showToast(
                                      msg:
