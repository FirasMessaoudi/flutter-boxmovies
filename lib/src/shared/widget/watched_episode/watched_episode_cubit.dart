...
import 'package:moviebox/src/core/repo/tv_episode_watchlist_repo.dart';
import 'package:moviebox/src/shared/widget/watched_episode/watched_episode_state.dart';

class WatchedEpisodeCubit extends Cubit<WatchedEpisodeState> {
  WatchedEpisodeCubit() : super(WatchedEpisodeState.initial());
  final repo = new TvWatchlistRepo();
